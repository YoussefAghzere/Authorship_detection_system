...
def preprocess_text(text):
    ...
    cleaned_words = [word for word in words if word in stop_words]
...
def plot_det_mutiple_curves(genuine_scores_list, imposter_scores_list, legends_list, title, filename):
    ...
    plt.savefig(f'/home/youssef/Desktop/A-measure-advanced/A_measure_advanced_figures/only_stopwords/{filename}')
